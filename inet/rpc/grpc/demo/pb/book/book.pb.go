...
import (
	...
	book "inet/rpc/grpc/demo/proto/book"
	reflect "reflect"
	sync "sync"
)
...
type Book struct {
	...
	Price *book.Price `protobuf:"bytes,2,opt,name=price,proto3" json:"price,omitempty"` // 为导入的price.proto与book.proto同属于一个package book;，所以可以直接使用price作为类型，无需添加 package 前缀（即无需写成book.price）
}
...
var file_book_book_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x42, 0x07, 0x5a, 0x05, 0x2f, 0x62,
