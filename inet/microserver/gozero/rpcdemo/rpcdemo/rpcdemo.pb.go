...
var file_rpcdemo_proto_goTypes = []any{
...
func file_rpcdemo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpcdemo_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_rpcdemo_proto_msgTypes[1].Exporter = func(v any, i int) any {
